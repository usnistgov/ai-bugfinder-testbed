...
class TokenizeCode(AbstractTokenizer):
    ...
    def to_regex(self, ops):
        """Joins a list of strings in a single one with separator to be used in a RegEx
        function.
    ...
    def process_file(self, filepath):
        """Process a single file transforming the content in tokens to create the corpus.
        Additional processing includes looking for certain types of operations like
