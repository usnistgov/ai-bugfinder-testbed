...
def process_features(features_file, feature_map_file, test_data_ratio=.33):

    assert 0. <= test_data_ratio <= 1.
...
#    LOGGER.info("Loading features...")
    ...
    split = rvals < np.percentile(rvals, int(100.*(1.-test_data_ratio)))
...
if __name__ == "__main__":
    features_file = "/home/user/Documents/ai-bugfinder/data/cwe121_small/features/interproc-features.json"
    feature_map_file = "/home/user/Documents/ai-bugfinder/data/cwe121_small/features/interproc-feature-map.json"
    xtr, xte, ytr, yte = process_features(features_file, feature_map_file, test_data_ratio=.33)
