...
class TestNeo4JAnnotationsConfigureContainer(TestCase):
    def setUp(self) -> None:
        patch_paths(
            self,
            ["bugfinder.processing.neo4j.annot.LOGGER", "bugfinder.base.processing.LOGGER"],
        )
    ...
    @patch("bugfinder.processing.neo4j.annot.super")
...
class TestNeo4JAnnotationsSendCommand(TestCase):
    ...
    @patch("bugfinder.processing.neo4j.annot.super")
    @patch("bugfinder.processing.neo4j.annot.Neo4JAnnotations.neo4j_db")
